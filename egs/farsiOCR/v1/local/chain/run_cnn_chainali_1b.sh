...
if [ $stage -le 4 ]; then
  ...
  input dim=28 name=input
  conv-relu-batchnorm-layer name=cnn1 height-in=28 height-out=28 time-offsets=-3,-2,-1,0,1,2,3 $common1
  conv-relu-batchnorm-layer name=cnn2 height-in=28 height-out=14 time-offsets=-2,-1,0,1,2 $common1 height-subsample-out=2
  conv-relu-batchnorm-layer name=cnn3 height-in=14 height-out=14 time-offsets=-4,-2,0,2,4 $common2
  conv-relu-batchnorm-layer name=cnn4 height-in=14 height-out=14 time-offsets=-4,-2,0,2,4 $common2
  conv-relu-batchnorm-layer name=cnn5 height-in=14 height-out=7 time-offsets=-4,-2,0,2,4 $common2 height-subsample-out=2
  conv-relu-batchnorm-layer name=cnn6 height-in=7 height-out=7 time-offsets=-1,0,1 $common3
  conv-relu-batchnorm-layer name=cnn7 height-in=7 height-out=7 time-offsets=-1,0,1 $common3
