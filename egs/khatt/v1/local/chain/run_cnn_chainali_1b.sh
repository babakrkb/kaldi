...
if [ $stage -le 4 ]; then
  ...
  input dim=48 name=input
  conv-relu-batchnorm-layer name=cnn1 height-in=48 height-out=48 time-offsets=-3,-2,-1,0,1,2,3 $common1
  conv-relu-batchnorm-layer name=cnn2 height-in=48 height-out=24 time-offsets=-2,-1,0,1,2 $common1 height-subsample-out=2
  conv-relu-batchnorm-layer name=cnn3 height-in=24 height-out=24 time-offsets=-4,-2,0,2,4 $common2
  conv-relu-batchnorm-layer name=cnn4 height-in=24 height-out=24 time-offsets=-4,-2,0,2,4 $common2
  conv-relu-batchnorm-layer name=cnn5 height-in=24 height-out=12 time-offsets=-4,-2,0,2,4 $common2 height-subsample-out=2
